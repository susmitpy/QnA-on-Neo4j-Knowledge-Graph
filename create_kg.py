...
def create_nodes():
    ...
    champaklal: Person = Person(first_name="Champaklal",surname="Gada", gender="M").save()
    ...
    aatmaram: Person = Person(first_name="Aatmaram", surname="Bhide",nick_name="Bhidu", gender="M").save()
    ...
    hansraj: Person = Person(first_name="Hansraj", surname="Haathi",nick_name="Hans", gender="M").save()
