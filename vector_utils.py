...
from models import INDEXES, Model
...
def search_nodes_rel(
    user_query: str, top_k: int = 10, score_thresh=0.5
) -> list[tuple[str, Model, float]]:
    """
    ...
    for query_embedding in query_embeddings:
        for entity, cypher in cypher_queries.items():
            ...
            results, meta = execute_cypher_query(
                cypher,
                {
